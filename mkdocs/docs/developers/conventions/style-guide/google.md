...
Si el motivo de la supresión no está claro a partir del nombre simbólico, agregue una explicación.
...
Por ejemplo, el módulo `sound.effects.echo` se puede importar de la siguiente manera:
