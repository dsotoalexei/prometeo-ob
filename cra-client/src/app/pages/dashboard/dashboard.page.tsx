...
import { EmptyRow, Loader } from '../../../libs/ui/components';

const DashboardPage = () => {
  const dispatch = useAppDispatch();
  const { user, isFetching, isError } = useAppSelector(userSelector);
  ...
  return (
    <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-28 lg:my-0">
      ...
      <div className="w-full lg:w-2/5">
        <img
          src="assets/images/card-profile.svg"
...
export { DashboardPage, DashboardPage as default };
